...
2.0 Running the Example on the C8051F326 target board
-----------------------------------------------------
	...
	1) Connect the hardware:
		...
		b) Install shorting blocks at the following positions: 
		   ...
		   J3[5-6] (P2.2 LED), J3[7-8] (P2.3 LED), J10 (P0.3).
	...
	2) Build and download the Interrupt Example firmware:
		...
		c) Connect to the target C8051F326 device (Alt+C, or IDE menu 
		   Debug->Connect).
		...
		d) From the Project menu, select "Open Project" and browse to the 
           ...
           default in the "Silabs\MCU\Examples\C8051F326_7\USB_Interrupt\Firmware"
           directory.
	...
	4) Run the Interrupt Example host application:
		...
		a) Run the SLAB_USB_Interrupt.exe application located by default in the
		   "Silabs\MCU\Examples\C8051F326_7\USB_Interrupt" directory.
		...
		c) Observe changes to SW1, SW2, Port pins, Potentiometer (NA), and
           Temperature (NA).
