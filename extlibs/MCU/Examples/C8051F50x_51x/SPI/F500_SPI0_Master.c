...
// 3) If communicating with the other 'F50x device on the Target Board, also
//    remove J32.
// 4) Verify the LED pins of jumper J19 are populated.
// 5) If communicating with the other 'F50x device on the Target Board, verify
