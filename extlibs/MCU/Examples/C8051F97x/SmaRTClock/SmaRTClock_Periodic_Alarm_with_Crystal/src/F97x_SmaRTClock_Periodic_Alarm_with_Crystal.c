...
#define RTC_ALARM_DELAY    500           // RTC Alarm delay in milliseconds
...
void main (void)
{
   ...
   RTC_Init (RTC_USE_CRYSTAL);           // Initialize SmaRTClock
   ...
   // Enable RTC Alarm and auto-reload of ALARM value
...
void PORT_Init (void)
{
   ...
   // Instructions based off of 26.4.1 in datashet
