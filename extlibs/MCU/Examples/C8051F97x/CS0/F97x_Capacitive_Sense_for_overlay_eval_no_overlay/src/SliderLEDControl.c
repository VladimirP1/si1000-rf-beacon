...
void SliderLEDUpdate(U8 centroid, U8 active)
{
   static U8 last_val=0xFF;
   xdata U8 index, new_val;
   TurnOffLEDs();
   if(!active)
   {
      last_val = 0xFF;
