...
-----------------------------------------------------
	...
	2) Build and download the Bulk Example firmware:
		...
		c) Connect to the target C8051F326/7 device (Alt+C, or IDE menu 
		   Debug->Connect).

		d) From the Project menu, select "Open Project" and browse to the 
		   Bulk Example Firware project "F326_USB0_Bulk.wsp", located by
           default in the "Silabs\MCU\Examples\C8051F326_7\USB_Bulk\Firmware"
           directory.
	...
	4) Run the Bulk Example host application:
		...
		a) Run the SLAB_USB_Bulk.exe application located by default in the
		   "Silabs\MCU\Examples\C8051F326_7\USB_Bulk" directory.
