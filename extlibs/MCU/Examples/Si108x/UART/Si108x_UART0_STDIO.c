...
// Program Description:
//
// This program demonstrates how to configure the Si100x to use routines
...
// 3) Download and execute code to the target board.
// 4) Disconnect and open Toolstick Terminal.
// 5) Connect to the device in Toolstick Terminal.  If no prompt is visible,
//    reset the device.
// 6) Type any character into the terminal when prompted.
//
//
// Target:         Si108x
// Tool chain:     Generic
