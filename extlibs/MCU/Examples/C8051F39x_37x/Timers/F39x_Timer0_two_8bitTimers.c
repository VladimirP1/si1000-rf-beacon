...
// How To Test:
//
// 1) Open the F390_Timer0_two_8bitTimers.c file in the Silicon Labs IDE
...
SBIT (LED, SFR_P1, 1);                 // LED==1 means ON, toggled by TL0
SBIT (SIGNAL, SFR_P1, 7);              // SIGNAL is toggled by TH0
