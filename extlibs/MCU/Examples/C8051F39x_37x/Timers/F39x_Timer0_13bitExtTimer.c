...
// How To Test:
//
// 1) Open the F390_Timer0_13bitExtTimer.c file in the Silicon Labs IDE
// 2) To change the number of input pulses/interrupt, modify
//    PULSES_PER_TOGGLE
// 3) To change the speed of the SIGNAL waveform, modify
//    SOFTWARE_DELAY
// 4) Compile the project
// 5) Download code to a 'F390 device
// 6) Place two shorting blocks on:
//       J8: SW  - P1.0
//       J8: LED - P1.1
...
// 8) Run the code
// 9) To enable the counting, press and hold P1.0 SW, which will be
...
#include <C8051F390_defs.h>            // SFR declaration
...
SBIT (SIGNAL, SFR_P1, 7);              // SIGNAL is used to input pulses into
                                       // T0 pin
SBIT (SW, SFR_P1, 0);                  // Button that enables counting
