...
// How To Test:
//
// 1) Open the F390_Timer2_two_8bitTimers.c file in the Silicon Labs IDE
// 2) If necessary change the number of interrupts to toggle an output:
//    LED_TOGGLE_RATE
//    SIGNAL_TOGGLE_RATE
// 3) Compile and download the code
// 4) Place one shorting block on J8: LED - P1.1
// 5) Run the code
...
SBIT (LED, SFR_P1, 1);                 // LED==1 means ON, toggled by TMR2L
SBIT (SIGNAL, SFR_P1, 7);              // SIGNAL is toggled by TMR2H
