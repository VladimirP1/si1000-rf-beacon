...
// 2) Uncomment the series of #define directives which correspond to your board.
// 3) Add a breakpoint to the _nop_ line featuring the comment "RUN TO HERE".
// 4) Execute the program. Upon reaching the breakpoint, access Code Memory by
//    selecting View -> Debug Windows -> Code Memory.
// 5) Scroll down to the last byte in code memory (e.g. 0x1FFF for the F850)
...
// 6) After inputting the lock byte value, click the "Refresh Values", and
//    then click the "Reset" button.
// 7) Run the code again. Then, halt the code. If the page lock was performed
