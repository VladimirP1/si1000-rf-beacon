...
// 3) Compile and download the code to your C8051F85x_86x board.
// 4) Run the code.
...
// 2) Compile and download the code to your C8051F85x_86x board.
// 3) Connect an oscilloscope probe to GND and P1.0
// 4) Run the code.
