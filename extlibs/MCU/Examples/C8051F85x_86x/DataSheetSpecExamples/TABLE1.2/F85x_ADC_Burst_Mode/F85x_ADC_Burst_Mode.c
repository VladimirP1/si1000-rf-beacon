...
// 5) Measure the current across Imeasure. This is the current with the ADC
//    burst mode enabled.
// 6) Use the switch at P2.1 (S2) to disable the ADC.
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) once. This will initialize the ADC for 10
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) twice. This will initialize the ADC for 10
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) three times. This will initialize the ADC
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) four times. This will initialize the ADC
//    for 10 bit burst mode using the internal reference and sampling rate of
//    100 ksps.
// 6) Measure the current across Imeasure. This reading is the current with
//    the ADC burst mode enabled.
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) five times. This will initialize the ADC
//    for 10 bit burst mode using the internal reference and sampling rate of
//    10 ksps.
// 6) Measure the current across Imeasure. This reading is the current with
//    the ADC burst mode enabled.
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) six times. This will initialize the ADC
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) seven times. This will initialize the ADC
//    for 12 bit burst mode using the external reference and sampling rate of
//    50 ksps.
// 6) Measure the current across Imeasure. This reading is the current with
//    the ADC burst mode enabled.
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) eight times. This will initialize the ADC
//    for 12 bit burst mode using the external reference and sampling rate of
//    10 ksps.
// 6) Measure the current across Imeasure. This reading is the current with
//    the ADC burst mode enabled.
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) nine times. This will initialize the ADC
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) ten times. This will initialize the ADC
//    for 12 bit burst mode using the internal reference and sampling rate of
//    50 ksps.
// 6) Measure the current across Imeasure. This reading is the current with
//    the ADC burst mode enabled.
...
//    b) S1 and P1.7 on J27
//    c) S2 and P2.1 on J27
// 5) Press the switch at P1.7 (S1) eleven times. This will initialize the ADC
//    for 12 bit burst mode using the internal reference and sampling rate of
//    10 ksps.
// 6) Measure the current across Imeasure. This reading is the current with
//    the ADC burst mode enabled.
...
SBIT(S1, SFR_P1, 7);                   // Switch 1
SBIT(S2, SFR_P2, 1);                   // Switch 2

//-----------------------------------------------------------------------------
// Function Prototypes
//-----------------------------------------------------------------------------

void ADC0_Init(U8,U8);
void SYSCLK_Init (void);
void Port_Init (void);
void Timer2_Init (U32);
...
{
   // Local variables
   U8 nextTestMode = ADC0_BURST_10_BIT_EXT_REF_100_KSPS;
   U16 debounceCounter;
   ...
   while (1)
   {
      ...
      {
         ADBMEN = !ADBMEN;             // Toggle ADC burst mode enable
...
//
//-----------------------------------------------------------------------------
void ADC0_Init (U8 reference, U8 resolution)
{
...
//
//-----------------------------------------------------------------------------
void Timer2_Init (U32 samplingRate)
{
