...
//  5) Measure the Output High Voltage (Low Drive) - Table 1.11
...
//        Drive).
//  6) Measure the Output Low Voltage (Low Drive) - Table 1.11
...
//  7) Measure the Output High Voltage (High Drive) - Table 1.11
...
//        Drive).
//  8) Measure the Output Low Voltage (High Drive) - Table 1.11
...
//  9) Test the Input High Voltage - Table 1.11
...
//        sweep.
// 10) Test the Input Low Voltage - Table 1.11
