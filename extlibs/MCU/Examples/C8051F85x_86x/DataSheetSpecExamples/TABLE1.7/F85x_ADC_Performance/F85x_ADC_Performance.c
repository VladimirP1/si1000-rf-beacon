...
//    frequency below 1 kHz (the sampling rate is 2 kHz). Configure the signal
//    to possess an amplitude of 3.3V peak-to-peak and an offset of 1600 mV.
// 6) Compile and download the code to your C8051F85x_86x board.
// 7) Run the code.
...
// 5) Attach a variable DC voltage source with a to the ADC Input (ADC0.10).
// 6) Compile and download the code to your C8051F85x_86x board.
// 7) Run the code.
// 8) Follow the instructions printed out in the UART terminal to take
//    10-bit or 12-bit sampling data.
...
void main (void)
{
   ...
   printf("---------------------------------------------- \n");      
   printf("Copyright (c) 2013 by Silicon Laboratories. \n"); 
   printf("\n");
