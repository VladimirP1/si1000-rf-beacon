...
// Program Description:
//
// This program presents an example of use of the Timer0 
// in 13-bit counter/timer mode. It blinks an LED. To do so it used an interrupt
// driven by the Timer0 which toggles the LED every 100msec.
//
// Pinout:
//
//    P1.0 -> LED
...
// follow these steps:
//
// 1) Open the Si106x_Timer0_13bitTimer.c file in the Silicon Labs IDE.
