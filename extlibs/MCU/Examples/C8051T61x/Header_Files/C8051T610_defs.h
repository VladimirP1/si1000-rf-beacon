...
// Program Description:
//
// Register/bit definitions for the C8051T61x family.
// **Important Note**: The compiler_defs.h header file should be included
// before including this header file.
//
// Target:         C8051T610, 'T611, 'T612, 'T613, 'T614, 'T615, 'T616, 'T617
// Tool chain:     Generic
// Command Line:   None
//
...
//     (pdata)
// Release 1.2 - 22 JULY 2008 (ES)
//    -Updated TMR2CN register bit definitions
//    -Deleted F31x_AMX0N SFR definition at location 0xBA
...
// Release 1.0 - 24 MAY 2007 (BW)
//    -Original port from 'F310 ver 1.2

//-----------------------------------------------------------------------------
// Header File Preprocessor Directive
//-----------------------------------------------------------------------------

#ifndef C8051T610_DEFS_H
#define C8051T610_DEFS_H
...
SFR (TOFFL, 0x85);                     // Temp Offset Low
SFR (TOFFH, 0x86);                     // Temp Offset High
