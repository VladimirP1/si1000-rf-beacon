...
//
//
// Target:         C8051T620/1/6/7, C8051T320/3
...
SEGMENT_VARIABLE (TEMP_ADD, const S16, SEG_CODE) = -228;
...
void Timer2_Init (void)
{
   ...
   CKCON  &= ~0xF0;                    // Timer2 clocked based on T2XCLK (SYSCLK/12)
...
// Return Value : None
// Parameters   :
//                1) U8 led: specified which LED to set (1 or 2)
//                2) U8 on: 0 means off, 1 means on
//
