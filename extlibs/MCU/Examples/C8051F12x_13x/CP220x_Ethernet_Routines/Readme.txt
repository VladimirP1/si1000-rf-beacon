...
1) Connect an AB4 to an 'F120 Target Board.
2) Connect the embedded system to a UART terminal @ 115200 8-N-1.
3) Connect the embedded system to a network.
4) Download the code to an 'F120 Target Board using the Silicon Labs IDE.
...
Note: This software is also compatible with the 'F34x Target Board. Please
