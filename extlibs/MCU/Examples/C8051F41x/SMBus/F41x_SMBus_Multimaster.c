...
//      - the 'F41x SMBus master should detect any conflict using ARBLOST
...
// How To Test:
//
// 1) Download code to a 'F41x device that is connected to another C8051Fxxx
//    SMBus multimaster.
